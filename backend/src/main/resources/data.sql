...
INSERT INTO tb_movie (title, sub_title, year, img_url, synopsis, genre_id) VALUES ('A Voz do Silêncio', 'Koe no Katachi', 2016, 'https://image.tmdb.org/t/p/w533_and_h300_bestv2/5lAMQMWpXMsirvtLLvW7cJgEPkU.jpg', 'Nishimiya Shouko é uma estudante com deficiência auditiva. Durante o ensino fundamental, após se transferir para uma nova escola, Shouko passa a ser alvo de bullying e em pouco tempo precisa se transferir. O que ela não esperava é que alguns anos depois, Ishida Shouya, um dos valentões que tanto a fez sofrer no passado surgisse de novo em sua vida com um novo propósito.', 2);
...
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Top demais!!!', 3, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Incrivel!!!', 4, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('O melhor que já vi até hoje!!!', 5, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Meh, filme OK', 6, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Gostei e recomendo!', 1, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Muito Ruim!!!', 7, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Adorei esse filme!!!', 8, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Queria mais tempo de filme!!!', 9, 2);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Até que passa!!!', 10, 2);
